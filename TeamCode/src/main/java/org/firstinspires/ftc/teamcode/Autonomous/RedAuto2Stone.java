...
public class RedAuto2Stone extends Robot {
    ...
    public void runOpMode() throws InterruptedException {
        try {
            ...
            driveToPoint3Intake(0, 12, 0, .20, 6, 6);
            driveToPoint3(0, -15, 0, .8, 0);
            ...
            driveToPoint3(0, -(70 + stoneDiff), 270 + driftAdjustment, 1, 0);
            ...
            driveToPoint(0, -14, 270 /*+ driftAdjustment*/, 2.0);
            ...
            if (pos == VuforiaStuff.skystonePos.LEFT) {
                driveToPoint3(0, 91 + stoneDiff2, 270 + driftAdjustment, 1, 0);
                intake.onSlow();
                turn_to_heading(315 + driftAdjustment, -20);
                driveToPoint3Intake(13, 13, 315 + driftAdjustment, .4, 1, 8);
                driveToPoint3(0, -25, 315 + driftAdjustment, .8, 0);
                liftSystem.grabStone();
                ...
                driveToPoint3Intake(0, 20, 0, .3, 0, 14);
                driveToPoint3(0, -16, 0 + driftAdjustment, .8, 0);
                liftSystem.grabStone();
                turn_to_heading(270 + driftAdjustment, -25);
                liftSystem.setHLiftPos(.75);
                driveToPoint3SpinStone(0, -(91 + stoneDiff2), 270 + driftAdjustment, 1, 0, 30);
            }
            liftSystem.dropStone();
            liftSystem.setStoneSpinnerPos(GlobalPositions.STONE_SPINNER_DOWN);
