...
public class RedAuto2Stone extends Robot {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        driveToPoint3(0, -(68 + stoneDiff), 270 + driftAdjustment, 1,0);
        ...
        grabbers.down();
        sleep(300);
        driveToPoint(0, 17, 180 + driftAdjustment, 3);
        turn_to_heading(265 + driftAdjustment, 15);
        liftSystem.dropStone();
        driveToPoint(0, -12, 270, 2.0);
        ...
        if (pos == VuforiaStuff.skystonePos.LEFT) {
            ...
            driveToPoint3(0, 95 + stoneDiff2, 270 + driftAdjustment, 1,0);
            intake.on();
            //liftSystem.hLift.setPower(-.3);
